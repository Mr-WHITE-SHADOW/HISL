...
async function notheri() {
    await heroku.get(baseURI + '/prabavi-vars').then(async (vars) => {
        therikick_var = vars.SAFE_MODE
    });
}
notheri()
var ldc = ''
...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (therikick_var == 'true' && message.jid !== '905511384572-1616356915@g.us') {
        let regex1 = new RegExp('https://chat')
        let regex2 = new RegExp('https://chat.whatsapp.')
        let regex3 = new RegExp('sew')
        let regex4 = new RegExp('Sew Quen')
        let regex5 = new RegExp('https://chat.whatsapp.com/')
        let regex6 = new RegExp('SEW QUEEN')
        let regex7 = new RegExp('Sew-Queen')
        let regex8 = new RegExp('Fuck')
        let regex9 = new RegExp('BUNG')
        let regex10 = new RegExp('Bang')
        let regex11 = new RegExp('sex')
        let regex12 = new RegExp('spam')
        let regex13 = new RegExp('ban')
